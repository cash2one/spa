    ...
    $.ajax({
        ...
        success : function(result){
            ...
            if(isPaidServiceItem){
                ...
                $('#content>div:nth-of-type(3)>div:nth-of-type(10)>span').Text(Math.round((new Date(result.userAct.useEndDate.split(' ')[0].replace(/-/g,'/')).getTime() - new Date().getTime())/86400000));
