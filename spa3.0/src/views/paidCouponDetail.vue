...
<template>
    <div>
        <div class="page paid-coupon-page" id="paid-coupon-detail-page" v-show="!global.loading"
             :style="{ height : (global.winHeight-(hidePayBtn ? 0 : 3.278)*global.winScale*16)+'px' }">
            ...
            <div class="detail-info">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <router-link
                                :to="{ name : 'confirmOrder', query : { techId : couponData.techs.id , clubId : couponData.clubId }}">
                            预约
                        </router-link>
                    </div>
                </div>
        ...
        <div class="paid-coupon-pay-btn" v-show="!hidePayBtn">
            <div :class="{ downline : footerBtnText=='已下线' , processing : inPaid }" @click="doClickPayBtn()">{{
                footerBtnText }}
            </div>
        </div>
    </div>
