<template>
    <div class="page club-list-page" id="club-list-search-page" v-show="!global.loading"
        ...
        <div class="page-title search-title">
            ...
            <input type="text" v-model="searchText" placeholder="输入会所名称、地址、技师标签" maxlength="50"
                   @keypress.enter="doClickSearchBtn()"/>
        ...
        <div class="club-list" v-show="!showTags && clubList.length>0">
            ...
            <div class="view-more" @click="doClickViewMore('club')" v-show="!showClubDataFinish"
                 :class="{ 'loading-data' : loadingClubData }"><span>{{ loadingClubData ? '正在加载...' : '查看更多会所' }}</span>
            </div>
        ...
        <div class="tech-list" v-show="!showTags && techList.length>0">
            ...
            <div class="view-more" @click="doClickViewMore('tech')" v-show="!showTechDataFinish"
                 :class="{ 'loading-data' : loadingTechData }"><span>{{ loadingTechData ? '正在加载...' : '查看更多技师' }}</span>
            </div>
...
<script>
    ...
    module.exports = {
        ...
        created: function () {
            var _this = this
            var currPage = _this.global.currPage.query
