...
<template>
    <div class="page" id="integral-detail-page" v-show="!global.loading" :style="{ height : global.winHeight+'px' }">
        ...
        <div class="tip" v-show="isNoIntegral">您没有积分了，
        ...
        <div class="list" ref="listEle" v-show="!isNoIntegral"
             :style="{ height : (global.winHeight-10.36*global.winScale*16)+'px' }" @scroll="doHandlerListScroll()">
    ...
    module.exports = {
        ...
        methods: {
            ...
            getUserAccount: function () {
                var _this = this
                _this.$http.get(_this.getUserAccountUrl, {
                    params: {
                        clubId: _this.clubId,
                        userType: 'user'
                    }
