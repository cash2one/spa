...
<template>
    <div class="page" id="review-list-page" v-show="!global.loading">
        ...
        <div class="comment-list" ref="listEle" :style="{ height : (global.winHeight-2.611*global.winScale*16)+'px' }"
             @scroll="doHandlerCommentListScroll()">
...
<script>
    ...
    module.exports = {
        ...
        created: function () {
            ...
            global.loading = true
            _this.$http.get(_this.queryTechCommentsUrl, {
                params: {
                    page: _this.currPage,
