...
<template>
    <div class="page" id="follow9358-page" v-show="!global.loading" :style="{ height : global.winHeight+'px' }">
        <div>
            <div class="top">
                <div class="club-info">
                    <div v-if="resData.imageUrl" :style="{ backgroundImage : 'url('+resData.imageUrl+')' }"
                         class="logo"></div>
                    <div class="info">
                ...
                <div class="tech-list" :class="{ club : !isTech && images.length>0 }">
                    <div v-for="img in images"
                         :style="{ backgroundImage : 'url('+(img || global.defaultHeader)+')' }"></div>
                </div>
...
<script>
    ...
    module.exports = {
        ...
        created: function () {
            ...
            _this.isTech = isTech
            _this.$http.get('../api/v2/club/clubortech/view', {
                params: {
