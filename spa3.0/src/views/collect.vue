...
<template>
    <div class="page" id="collect-page" v-show="!global.loading" :style="{ height : global.winHeight+'px' }">
        ...
        <div class="list" ref="listEle" :style="{ height : (global.winHeight-2.611*global.winScale*16)+'px' }"
            ...
            <div class="list-item" v-for="singleClubData in dataList">
                ...
                <router-link class="item" v-for="item in singleClubData.list"
                             :to="{ name : 'technicianDetail', query : { id : item.techId } }">
                    <div>
