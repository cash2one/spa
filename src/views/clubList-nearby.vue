<template>
    <div class="page club-list-page" id="club-list-nearby-page" v-show="!global.loading">
        <div class="search"><router-link :to="{ name : 'inviteCode' , query : { tmp_clubSource : '9358' } }">添加会所</router-link><router-link tag="div" :to="{ name : 'clubList-search' }"><span>搜索</span></router-link></div>
        <div class="title">附近会所<router-link :to="{ name : 'clubList-all' }">查看全部</router-link></div>
...
<script>
    ...
    module.exports = {
        ...
        created : function(){
            ...
            _this.$http.get("../api/v2/club/near/clubs",{ params : {
