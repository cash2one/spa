        ...
        $.ajax({
            ...
            success: function (result) {
                if(result.statusCode == 200){
                    ...
                    $('#projectExplain>div:nth-of-type(2)>div:nth-of-type(2)>div:nth-of-type(2)>div>span')
                      .Text(result.useStartDate.split(' ')[0] + ' - ' + result.useEndDate.split(' ')[0]);
                    $('#projectExplain>div:nth-of-type(2)>div:nth-of-type(2)>div:nth-of-type(2)>div:nth-of-type(2)').Html(result.instructions);
