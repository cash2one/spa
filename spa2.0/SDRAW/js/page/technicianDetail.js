    ...
    $.ajax({
        ...
        success: function (data) {
          ...
          if(isCrossInner&&data.info.status == 'busy'&&data.info.endTime){
            ...
            $('#content>div:nth-of-type(1)>div:nth-of-type(1)>div:nth-of-type(2)>div:nth-of-type(3)').Text({free:'闲',busy:'忙',rest:'休'}[data['info']['status']]);
